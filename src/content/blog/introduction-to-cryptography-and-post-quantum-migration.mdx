...
An introduction to classical and post-quantum cryptography from first principles. Everything I learned during onboarding as an intern at Project Eleven, from AES and RSA to Shor's algorithm and [NIST's](https://csrc.nist.gov/pubs/fips/203/final) new PQC standards.
